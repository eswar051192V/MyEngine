...
import { ResponsiveContainer, PieChart, Pie, Cell, Tooltip as ReTooltip, LineChart, Line, XAxis, YAxis, CartesianGrid, Legend } from 'recharts';
        ...
        <div className="md-content mw-content pf-page mdl-page mdl-page--redesign mdl mdl--dense">
            <header className="md-hero wl-hero mdl-hero">
                ...
                <p className="md-hero__sub">
                    Same dense watchlist design language: books, holdings, ledger analytics, and Ollama copilot in one surface.
                </p>
