...
export const resolveSegmentKey = (purchaseType = '', segment = '') => {
  ...
  if (normalizedSegment === 'gold' || normalizedSegment === 'silver' || normalizedSegment === 'platinum' || normalizedSegment === 'copper') {
    return 'commodity_futures';
  }
  if (normalizedSegment === 'fx') return 'currency';
  if (normalizedSegment.startsWith('real estate')) return 'equity_delivery';
